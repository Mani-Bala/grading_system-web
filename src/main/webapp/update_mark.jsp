...
<nav class="navbar navbar-expand-sm navbar-dark bg-dark">
	...
	<h3>Update Student Marks</h3><br><br>
	<div id="message"></div><br>
	
	<form onsubmit="updateMark()" >
	Enter the Register Number     :
	<input type="number" id="regno" min="1000" max="1100" required autofocus/><br><br>
	Enter the Mark for ENGLISH :
	<input type="number" id="english" min="0" max="100" required><br><br>
	Enter the Mark for MATHS :
	<input type="number" id="maths" min="0" max="100" required><br><br>
	Enter the Mark for PHYSICS :
	<input type="number" id="physics" min="0" max="100" required><br><br>
	Enter the Mark for CHEMISTRY :
	<input type="number" id="chemistry" min="0" max="100" required><br><br>
	Enter the Mark for COMPUTER :
	<input type="number" id="computer" min="0" max="100" required><br><br>
